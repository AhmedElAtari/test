...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Derichebourg | Authentification</title>
        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo site_url("auth/login");?>" method="post">
                ...
                <div class="alert alert-danger display-hide">
                    ...
                    <span> Entrer le nom d'utilisateur et le mot de passe. </span>
                </div>
                <div class="alert alert-danger <?=isset($error_message)?'display':'display-hide'?> ">
                    <button class="close" data-close="alert"></button>
                    <span> <?=isset($error_message)?$error_message:""?> </span>
                </div>
