            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item start <?php if($current_controller == 'Document') echo 'active';?>">
                            <a href="<?php echo site_url('Document')?>" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item start ">
                                    <a href="<?php echo site_url('Document')?>" class="nav-link ">
                                        <i class="icon-bar-chart"></i>
                                        <span class="title">Liste de documents</span>
                                    </a>
                                </li>
                                <li class="nav-item start ">
                                    <a href="<?php echo site_url('Document/nouveau')?>" class="nav-link ">
                                        <i class="icon-bar-chart"></i>
                                        <span class="title">Nouveau document</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item start <?php if($current_controller == 'Analyse') echo 'active';?>">
                            <a href="<?php echo site_url('Analyse')?>" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                        ...
                        <li class="nav-item start">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                                <span class="title">Consommation</span>
                                <!-- <span class="arrow"></span> -->
                            </a>
                        </li>
                        <li class="nav-item start">
